...
const legalContent: Record<string, { title: string; updated: string; sections: { heading: string; body: string }[] }> = {
  ...
  terms: {
    ...
    sections: [
      ...
      { heading: '2. Services Offered', body: 'We provide (a) SaaS products including Kada Dine, Kada Stay, SellrApp, Kada Ledger, DevFlow, and Lunoo, and (b) custom software development services. Individual products and engagements may carry additional specific terms.' },
