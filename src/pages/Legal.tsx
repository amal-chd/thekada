...
const legalContent: Record<string, { title: string; updated: string; sections: { heading: string; body: string }[] }> = {
  privacy: {
    ...
    sections: [
      { heading: '1. Introduction', body: 'The Kada Digital Ventures Pvt Ltd ("we", "our", "us") respects your privacy and is committed to protecting your personal data. This policy explains how we collect, use, and safeguard information when you use our SaaS products — Kada Dine, Kada Dine Hotel, SellrApp, Kada Ledger, DevFlow, and Lunoo — our websites, and our custom software services.' },
  ...
  terms: {
    ...
    sections: [
      ...
      { heading: '2. Services Offered', body: 'We provide (a) SaaS products including Kada Dine, Kada Dine Hotel, SellrApp, Kada Ledger, DevFlow, and Lunoo, and (b) custom software development services. Individual products and engagements may carry additional specific terms.' },
